...
a = plot_sem(gca,t,pulses(pulse_length>1,:) - mean(pulses(pulse_length>1,:),2,'omitnan')); a.FaceColor = [1,0,0];
a = plot_sem(gca,t,pulses(pulse_length<1,:) - mean(pulses(pulse_length<1,:),2,'omitnan')); a.FaceColor = [1,.7,.7];
